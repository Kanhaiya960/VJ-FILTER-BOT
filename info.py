...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002462264302').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002341031402') # give your force subscribe channel id here else leave it blank
...
INDEX_REQ_CHANNEL = environ.get('INDEX_REQ_CHANNEL', '-1002450886765')
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002410949273').split()]  # For Multiple Id Use One Space Between Each.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Kanus_Support') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '8585479c122feb4c124dbad84240f316e5b6de21')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Movies_4_Download/633')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Movies_4_Download/633') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
